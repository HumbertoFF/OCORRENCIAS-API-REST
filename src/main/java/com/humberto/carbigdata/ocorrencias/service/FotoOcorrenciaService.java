...
import com.humberto.carbigdata.ocorrencias.repository.FotoOcorrenciaRepository;
...
public class FotoOcorrenciaService {
  ...
  public List<FotoResponse> adicionarFotos(Long codOcorrencia, List<MultipartFile> arquivos) {
    ...
    for (MultipartFile arquivo : arquivos) {
      ...
      MinioStorageService.UploadResult resultado = storageService.upload(arquivo, prefixo);
